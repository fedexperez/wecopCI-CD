...
CREATE TABLE IF NOT EXISTS `eco_products` (
  ...
  `not_eco_product` bigint(20) UNSIGNED NOT NULL FOREIGN KEY (`not_eco_product`) REFERENCES `not_eco_products` (`id`),
